...
| 12 | Planned | Problem 3 (medium): Uniform Reliable Broadcast with crash faults | same as 10 |
| 13 | Planned | E2E hardening: replay endpoint, full-flow test, seed pinning, polish | all |
